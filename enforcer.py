...
if sys.platform == "darwin":
    ...
    sweep_minimize_blocked_windows = _mac.sweep_minimize_blocked_windows
    show_blocked_notice = _mac.show_blocked_notice
    restore_window_for_process = _mac.restore_window_for_process
    restore_all_taskbar_previews = _mac.restore_all_taskbar_previews
