...
def test_card_shows_no_visible_trace_of_unlabeled_status(qtbot, isolate_board):
    """"Un-labeled" is a purely backend/filtering concept -- a tagless
    task's card must look completely ordinary, no pill and no styling
    change of any kind."""
